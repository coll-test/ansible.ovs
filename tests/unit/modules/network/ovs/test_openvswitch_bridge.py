...
from ansible_collections.ansible.ovs.plugins.modules import openvswitch_bridge
from ansible_collections.ansible.ovs.tests.unit.compat.mock import patch, MagicMock
from ansible_collections.ansible.ovs.tests.unit.modules.utils import set_module_args
